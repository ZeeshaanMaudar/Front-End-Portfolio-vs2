          ...
          <div class="col-md-12 container" id="">
            ...
            <div class="row skill">
              ...
              <div class="col-lg-3 col-sm-6 logo-container NODEJS">
                <img class="logo node" src="assets/images/Zeeshaan-maudarbocus-front-end-skill-nodejs.jpg" alt="Zeeshaan does cool animation with jQuery logo" title="Zeeshaan does cool animation with Node.js logo">
                <h3 class="logo-title">Node.js</h3>
              </div>

              <div class="col-lg-3 col-sm-6 logo-container EXPRESSJS">
                <img class="logo express" src="assets/images/Zeeshaan-maudarbocus-front-end-skill-expressjs.png" alt="Zeeshaan does cool animation with jQuery logo" title="Zeeshaan does cool animation with Express.js logo">
                <h3 class="logo-title">Express.js</h3>
              </div>

              <div class="col-lg-3 col-sm-6 logo-container MONGODB">
                <img class="logo mongodb" src="assets/images/mongoDB.png" alt="Zeeshaan does cool animation with jQuery logo" title="Zeeshaan does cool animation with MongoDB logo">
  ...
  <section id="portfolio-section" class="row col-12">
    ...
    <div class="col-md-10 container">
      ...
      <div class="row col-12 img-holder">
        <div class="col-xs-12 col-md-6 col-lg-4 img-con">
          <a href="photo-grid/index.html" target="_blank">
            ...
            <div class="col-12 text-con">
              <p class="project-title">Image Gallery</p>
            </div>
            <div class="col-12 text-con">
              <p class="inner-p">
        ...
        <div class="col-xs-12 col-md-6 col-lg-4 img-con">
          <a href="image-gallery/index.html" target="_blank">
            <div class="col-12 img-block">
              <img class="an-img" src="assets/images/thumbnails/Zeeshaan-Maudarbocus-website-image-gallery.jpg" alt="Zeeshaan's thumbnail for web development project 3" title="Zeeshaan's thumbnail for web development project 3" />
            </div>

            <div class="col-12 text-con">
              <p class="project-title">Bootstrap Image Gallery</p>
              <p class="inner-p">
